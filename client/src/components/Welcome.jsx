    ...
    return (
        <div className="flex w-full justify-center item-center">
            <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-10">
                <div className="flex flex-1 justify-start flex-col 2xl:mr-60 xl:mr-40 lg:mr-20 px-20 py-6">
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
                    <div className="p-3 justify-end items-start flex-col rounded-xl h-44 sm:w-80 w-full mb-7 eth-card white-glassmorphism border-none">
